...
std::string apple_turnover(int number) {
  if (pow(number, 2) > 1000) {
...
int main() {
  if (apple_turnover(31) != "Help yourself to a honeycomb Yorkie for the glovebox.") {
    return 1;
  }
  
  if (apple_turnover(32) != "It's hotter than the sun!!") {
    return 1;
  }
